...
public class Order
{
    // Create a public constructor function named Order with the parameters 
    // ArrayList<Cupcake> cupcakeMenu, ArrayList<Drink> drinkMenu
    public Order(ArrayList<Cupcake> cupcakeMenu, ArrayList<Drink> drinkMenu)
    {
        ...
        // Create a String object named placeOrder and set it equal to input.nextLine()
